...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex  items-center justify-center gap-2 px-6 pt-[15px]">
        <NavLink to="/super-admin/dashboard">
          <img src={'https://www.gkexpertise.com/wp-content/uploads/2023/09/cropped-gk-expertise-logo-1.png'} alt="Logo" />
        </NavLink>
