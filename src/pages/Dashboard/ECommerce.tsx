...
<DefaultLayout>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total Expenses" total="$3.456K" rate="0.43%" levelUp>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="18px" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1">
    <path fill="none" stroke="blue" stroke-miterlimit="10" stroke-width="1.91" d="M12,12H22.5a10.45,10.45,0,0,1-3.07,7.42L12,12V1.48A10.5,10.5,0,1,0,19.43,19.4"/>
    <path fill="none" stroke="blue" stroke-miterlimit="10" stroke-width="1.91" d="M15.82,8.16h3.34a1.43,1.43,0,0,0,1.43-1.43h0A1.43,1.43,0,0,0,19.16,5.3h-1a1.44,1.44,0,0,1-1.43-1.44h0A1.43,1.43,0,0,1,18.2,2.43h3.35"/>
    <line fill="none" stroke="blue" stroke-miterlimit="10" stroke-width="1.91" x1="18.68" y1="0.52" x2="18.68" y2="2.43"/>
    <line fill="none" stroke="blue" stroke-miterlimit="10" stroke-width="1.91" x1="18.68" y1="8.16" x2="18.68" y2="10.07"/>
</svg>
